...
let curveIt= document.querySelector("#submit");
...
let totalPoints = document.querySelector("#scores");
let clear = document.querySelector("#reset");


clear.addEventListener('click', function(){
    grade.textContent = 'Curved grades shows here';
    totalPoints.value ="";
});
...
function curveGrades() {
    ...
    gradeSlice = (maxGrade - minGrade) / 5; //5 grades A, B, C, D, E, F
    aryGrades.forEach(applyBell)

    grade.textContent = aryGrades.join(" , ");
 }
...
signature.innerText = "FSW113 week3 Rafael Fernandez";
