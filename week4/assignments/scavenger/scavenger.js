...
function combineLists() {
    let wrap0 = document.getElementById('scavenger-0').value.split(',');
    let wrap1 = document.getElementById('scavenger-1').value.split(',');
    let wrap2 = document.getElementById('scavenger-2').value.split(',');
    let wrap3 = document.getElementById('scavenger-3').value.split(',');

    const allWrappedUp = [...wrap0, ...wrap1, ...wrap2, ...wrap3].sort();

    document.getElementById('AllItems').innerText = allWrappedUp.join(',');
